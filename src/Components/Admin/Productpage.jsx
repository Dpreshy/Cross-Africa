...
import "./style.css"
const Productpage = ({ avatar, index, name, price, tag, created, quantity, active, rejected, status,category,id }) => {
      ...
      {tag && <Td>
        ...
        <HoldHead>{ rejected}</HoldHead>
          ...
          {edit ? (
              ...
              >
                <NavLink  to="/admin-dashboard/edit-image"><Navs>Edit Image</Navs></NavLink>
                <NavLink  to={`/admin-dashboard/update-status/${id}`}><Navs>Update Status</Navs></NavLink>
                <Navs>Delete</Navs>
              </Menu>
            ) : null}
        </HoldHead>
